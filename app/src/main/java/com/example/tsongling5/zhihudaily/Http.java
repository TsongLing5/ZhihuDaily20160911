...
public class Http {
    ...
    public static String THEME="http://news-at.zhihu.com/api/4/theme/";  //http://news-at.zhihu.com/api/4/theme/4
    ...
    public static String getNewsList(String url) throws IOException{
        return get(url);
    }
